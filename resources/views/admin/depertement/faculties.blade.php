                ...
                <div class="card-body p-3">
                    ...
                    <table class="data-table w-100" id="dataTable">
                        ...
                        <tr>
                            ...
                            <th scope="col">Nom de faculté</th>
                            <th scope="col">Nom de faculté en arabe</th>
                        ...
                        @foreach ($faculties as $key => $faculté)
                            ...
                            <tr>
                                ...
                                <td id="firstnamess">
                                    {{$faculté->faculty_code}}
                                </td>
                                <td id="lastnamess">

                                    {{$faculté->faculty_code_ar}}

                                </td>
                                <td id="dateOfBirthss">
                                    {{$faculté->faculty_creation_date}}
                                </td>


                                <td><h5>
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-edit/{{$faculté->faculty_id}}" id="btn-edit"  ><i class="fa fa-edit"></i></a>
                                        {{-- data-bs-toggle="modal" data-bs-target="#bootstrapBasicModal" --}}
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-delete/{{$faculté->faculty_id}}" id="btn-delete"><i class="fa fa-close"></i></a>
                                    </h5>
                                </td>
                            </tr>
