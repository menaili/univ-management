...
@section('title-page', 'specialities')
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    ...
                    <table class="data-table w-100" id="dataTable">
                        <thead>
                        <tr>
                            <th scope="col">specialité ID</th>
                            <th scope="col">Nom de filière</th>
                            <th scope="col">Nom de specialité</th>
                            <th scope="col">Nom de specialité en arabe</th>
                        ...
                        @foreach ($specialities as $key => $speciality)
                            ...
                            <tr>
                                ...
                                <td id="dateOfBirthss">
                                    {{$speciality->division_code_fr}}
                                </td>

                                <td id="firstnamess">
                                    {{$speciality->speciality_code_fr}}
                                </td>
                                <td id="lastnamess">
                                ...
                                <td id="dateOfBirthss">
                                    {{$speciality->speciality_creation_date}}
                                </td>


                                <td><h5>
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-edit/{{$speciality->speciality_id}}" id="btn-edit"  ><i class="fa fa-edit"></i></a>
                                        {{-- data-bs-toggle="modal" data-bs-target="#bootstrapBasicModal" --}}
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-delete/{{$speciality->speciality_id}}" id="btn-delete"><i class="fa fa-close"></i></a>
                                    </h5>
                                </td>
                            </tr>
