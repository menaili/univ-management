                ...
                <div class="card-body p-3">
                    ...
                    <table class="data-table w-100" id="dataTable">
                        ...
                        <tr>
                            ...
                            <th scope="col">Nom de domain en arabe</th>
                        ...
                        @foreach ($domains as $key => $domain)
                            ...
                            <tr>
                                ...
                                <td id="dateOfBirthss">
                                    {{$domain->domain_creation_date}}
                                </td>


                                <td><h5>
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-edit/{{$domain->domain_id}}" id="btn-edit"  ><i class="fa fa-edit"></i></a>
                                        {{-- data-bs-toggle="modal" data-bs-target="#bootstrapBasicModal" --}}
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-delete/{{$domain->domain_id}}" id="btn-delete"><i class="fa fa-close"></i></a>
                                    </h5>
                                </td>
                            </tr>
