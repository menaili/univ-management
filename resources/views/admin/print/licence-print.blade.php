...
@section('title-page', 'Demandes licence')
                        ...
                        @foreach ($requests as $key => $request)
                            ...
                            <tr>
                                ...
                                <td id="btn-next">
                                    ...
                                    <div class="direction-rtl"><a class="btn m-1 btn-outline-primary" id="btn-step" href="/univ-certaficate-management/public/printPDF/{{$request->request_bachlor_id}}">imprimer</a></div>
