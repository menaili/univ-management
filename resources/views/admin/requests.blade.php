      ...
      <div class="card" style=" width: 1100px;">
        ...
        <th scope="col">Status</th>
            ...
            <tbody >
                ...
                @foreach ($requests and $faculty as $key => $request)
                ...
                <tr>
                    ...
                    {{$request->requests_id}}
                      ...
                      <td id="firstnamess">
                    {{$request->requests_student_first_name}}
                      </td>
                      <td id="lastnamess">

                    {{$request->requests_student_second_name}}

                      </td>
                      <td id="dateOfBirthss">
                    {{$request->requests_student_birthday}}
                      </td>
                      <td id="levelss ">
                        {{$request->level_id}}
                      </td>
