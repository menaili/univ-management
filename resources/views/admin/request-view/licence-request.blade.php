                        ...
                        @foreach ($requests as $key => $request)
                            ...
                            <tr>
                                ...
                                <td id="diplomanumberss">
                                    {{$request->bachlor_diploma_number}}
                                </td>
                                <td id="notess">
                                    {{$request->bachlor_note}}
                                </td>
                                <td >
                                    {{$request->bachlor_status_date}}
                                </td>
                                <td><h5>
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-edit/{{$request->request_bachlor_id}}" id="btn-edit"  ><i class="fa fa-edit"></i></a>
                                        {{-- data-bs-toggle="modal" data-bs-target="#bootstrapBasicModal" --}}
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-delete/{{$request->request_bachlor_id}}" id="btn-delete"><i class="fa fa-close"></i></a>
                                    </h5>
                                </td>
                            </tr>
