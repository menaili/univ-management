                        ...
                        @foreach ($requests as $key => $request)
                            ...
                            <tr>
                                <td style="text-align:center;">
                                    {{$request->request_veterinary_id}}
                                </td>

                                <td id="firstnamess">
                                    {{$request->veterinary_student_first_name}}
                                </td>
                                <td id="lastnamess">

                                    {{$request->veterinary_student_last_name}}

                                </td>
                                <td id="dateOfBirthss">
                                    {{$request->veterinary_student_birthday}}
                                </td>
                                ...
                                <td id="diplomanumberss">
                                    {{$request->veterinary_diploma_number}}
                                </td>
                                <td id="notess">
                                    {{$request->veterinary_note}}
                                </td>
                                <td >
                                    {{$request->veterinary_status_date}}
                                </td>
                                <td><h5>
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-edit/{{$request->request_veterinary_id}}" id="btn-edit"  ><i class="fa fa-edit"></i></a>
                                        {{-- data-bs-toggle="modal" data-bs-target="#bootstrapBasicModal" --}}
                                        <a class="remove-product" href="/univ-certaficate-management/public/Requests-delete-veterinary/{{$request->request_veterinary_id}}" id="btn-delete"><i class="fa fa-close"></i></a>
                                    </h5>
                                </td>
                            </tr>
