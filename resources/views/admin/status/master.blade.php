                        ...
                        @foreach ($requests as $key => $request)
                            ...
                            <tr>
                                ...
                                <td id="btn-next">
                                    ...
                                    <div class="direction-rtl"><a class="btn m-1 btn-outline-primary" id="btn-step" href="/univ-certaficate-management/public/Status-update-master/{{$request->request_master_id}}">Next step</a></div>
